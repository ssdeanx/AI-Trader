...
class MCPServiceManager:
    def __init__(self):
        ...
        self.ports = {
            ...
            "technical": int(os.getenv("TECHNICAL_HTTP_PORT", "8007")),
        }
        ...
        self.service_configs = {
            ...
            "sentiment": {"script": os.path.join(mcp_server_dir, "tool_sentiment_analysis.py"), "name": "SentimentAnalysis", "port": self.ports["sentiment"]},
            "technical": {"script": os.path.join(mcp_server_dir, "tool_technical_indicators.py"), "name": "TechnicalIndicators", "port": self.ports["technical"]},
        }
